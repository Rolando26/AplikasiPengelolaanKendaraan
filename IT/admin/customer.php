      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Daftar Nama Pemohon</li>
          </ol>
        </section>
          ...
          <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-primary">
                              <div class="box-header">
                                ...
                                <h3 class="box-title">List Nama Pemohon</h3>
                  ...
                  $b=mysqli_num_rows($a);
                  $nomorgan=1;
                  while ($rows=mysqli_fetch_array($a) AND  $rews=mysqli_fetch_array($c)){
                                  ...
                                  <td><a class=update href='update-customer.php?id=".$rows['id']."'>UPDATE</a>&nbsp;&nbsp;&nbsp;
                                  <a class=delete href='delete.php?id=".$rows['id']."'>DELETE</a>&nbsp;&nbsp;&nbsp;
                                  <a class=setuju href='print.php?id=".$rows['id']."'>APPROV</a></td>
