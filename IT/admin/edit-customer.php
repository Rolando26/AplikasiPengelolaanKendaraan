...
<?php include "waktu.php"; ?>
      ...
      <div class="content-wrapper">
        ...
        $notes    = $_POST['notes'];
				...
				$update = mysqli_query($koneksi, "UPDATE customer SET nama_cus='$nama_cus', alamat='$alamat', kota='$kota', no_telp='$no_telp', pic='$pic', hp='$hp', email='$email', notes='$notes' WHERE kd_cus='$kd'") or die(mysqli_error());
				if($update){
			...
			?>
                ...
                <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                         <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <input name="kd_cus" type="text" id="kd_cus" class="form-control" value="<?php echo $row['kd_cus']; ?>" placeholder="Auto Number" autocomplete="off" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
