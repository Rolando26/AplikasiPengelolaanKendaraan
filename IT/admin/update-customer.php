           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="prosesupdate-customer.php" method="post" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Pemohon</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="bagian" class="form-control" id="bagian" type="text" value="<?php echo $data['bagian'];?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="kegiatan" class="form-control" id="kegiatan" type="text" value="<?php echo $data['kegiatan'];?>" required />
                              </div>
                          </div>

                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jumlah Peserta</label>
                              <div class="col-sm-10">
                                  <input name="jumlahpeserta" class="form-control" id="jumlahpeserta" type="text" value="<?php echo $data['jumlahpeserta'];?>" required />
                              </div>
                          </div>
